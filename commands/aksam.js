...
module.exports = {
    execute: async (sock, chatId) => {
        ...
        try {
            const response = await axios.get("http://fatihgulcu.com.tr/api/kykaksam.php");
            let replyText = response.data.reply || "Akşam yemeği bilgisi alınamadı.";
            ...
            if (Array.isArray(replyText)) {
                ...
                replyText = "Akşam yemeği bilgisi alınamadı.";
            }
